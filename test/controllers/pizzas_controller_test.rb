...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { flavor_id: @pizza.flavor_id, sauce_id: @pizza.sauce_id, shape_id: @pizza.shape_id, size_id: @pizza.size_id, total_prices: @pizza.total_prices } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { flavor_id: @pizza.flavor_id, sauce_id: @pizza.sauce_id, shape_id: @pizza.shape_id, size_id: @pizza.size_id, total_prices: @pizza.total_prices } }
